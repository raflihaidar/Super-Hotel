                ...
                <div v-for="(item, index) in category" :key="index"
                    ...
                    <span class="flex flex-col items-end gap-y-10 w-[35%]">
                        ...
                        <button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                            ...
                            class="text-white items-end bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Green</button>
                    </span>
                </div>
            </div>
        </section>
