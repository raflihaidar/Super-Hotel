            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Master Room</span>
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Staff Management</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="m1 1 4 4 4-4" />
                    ...
                    <ul id="dropdown-staff" class="hidden py-2 space-y-2">
                        ...
                        <router-link :to="{ name: 'shift' }">
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Shift</a>
                        </router-link>
                        <router-link :to="{ name: 'division' }">
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Division</a>
                        </router-link>
                    </ul>
                </li>
                <li>
                ...
                <router-link :to="{ name: 'guest' }">
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Guest Management</span>
                    </a>
                </router-link>
            </ul>
        </div>
